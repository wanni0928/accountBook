...
public class InputAccount implements Create, Delete, Update {
    ...
    public void showInputAccount() {
        String input = "";
        String guidance =
                "\n<가계부 입력페이지> 이용하고 싶은 메뉴 번호를 입력 해주세요.\n" +
                "1. 추가하기\n" +
                        "2. 수정하기\n" +
                        "3. 삭제하기\n";
    ...
    private void showDeleteForm() {
        ...
        while (!input.equals("q")) {
            System.out.println("삭제하기를 선택하셨네요. 뭘 원하십니까? 숫자로 쓰세요.");
    ...
    private void showUpdateAccount() {
        ...
        while (!input.equals("q")) {
            System.out.println("수정하기를 선택하셨습니다. 원하시는 기능을 번호로 입력 해주세요.");
            System.out.println("1. 작성 목록 확인하기");
            ...
            switch (Integer.parseInt(input)){
                ...
                case 2:
                    ...
                    if(account != null) {
                        ...
                        input = scanner.nextLine();
                        if(input.equals("q")) update(account, accountForm);
                    }else {
